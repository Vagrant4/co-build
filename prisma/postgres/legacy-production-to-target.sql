-- CreateEnum
CREATE TYPE "FactoryType" AS ENUM ('B1', 'B2', 'UNKNOWN');
...
-- DropForeignKey
ALTER TABLE "ListingMessage" DROP CONSTRAINT "ListingMessage_listingId_fkey";

-- DropForeignKey
ALTER TABLE "ListingMessage" DROP CONSTRAINT "ListingMessage_senderId_fkey";
...
DROP COLUMN "zoning",
ADD COLUMN     "factoryType" "FactoryType" NOT NULL;
...
ADD COLUMN     "legacyLocalPath" TEXT,
ADD COLUMN     "objectKey" TEXT,
ADD COLUMN     "ownerUserId" TEXT,
ADD COLUMN     "scanStatus" "ScanStatus" NOT NULL DEFAULT 'PENDING',
ADD COLUMN     "sizeBytes" INTEGER,
ADD COLUMN     "storageProvider" "StorageProvider" NOT NULL DEFAULT 'VERCEL_BLOB',
